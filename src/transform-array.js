  ...
  for (let i = 0; i <= arr.length; i++) {
    if (arr[i] === "--discard-next") {
      newArr[newArr.indexOf("--discard-next") + 1]
        ? newArr.splice(newArr.indexOf("--discard-next"), 2, null)
        : newArr.splice(newArr.indexOf("--discard-next"), 1, null);
    } else if (arr[i] === "--discard-prev") {
      newArr[newArr.indexOf("--discard-prev") - 1]
        ? newArr.splice(newArr.indexOf("--discard-prev") - 1, 2, null)
        : newArr.splice(newArr.indexOf("--discard-prev"), 1, null);
